				...
				<div className="tarms_wrapper">
					<div className="tarms_item">
						...
						<p className="text">
							...
							aufgeben, erklären Sie sich mit der Einhaltung dieser Geschäftsbedingungen
							einverstanden. Wenn Sie nicht mit allen diesen Gf Bestellungen aufgeben. <br />
							<br />
							Diese Allgemeinen Geschäftsbedingungen können jederzeit geändert werden; Sie sollten
							sie zur Kenntnis nehmen, bevor Sie eine Bestellung aufgeben. Es gelten automatisch die
							zum Zeitpunkt Ihres Besuchs auf der Website oder zum Zeitpunkt des Vertragsabschlusses
							geltenden Bedingungen (wie unten definiert). <br />
							<br />
							Der Vertrag (wie unten definiert) kann in jeder der Sprachen ausgeführt werden, in
							denen die Allgemeinen Geschäftsbedingungen verfügbar sind.
						</p>
					</div>
					<div className="tarms_item">
						...
						<p className="text">
							...
							<span className="mb-2 text d-block">Oder</span>
							<a href="hello@colonpax.com">hello@colonpax.com</a>
						</p>
					</div>
					<div className="tarms_item">
						<h5 className="tarms_heading5">3. IHRE ANGABEN UND WEBSITE-BESUCHE</h5>
						<p className="text">
							Alle von Ihnen gelieferten Informationen oder persönlichen Daten werden gemäß den in
							der Datenschutzerklärung festgelegten Bedingungen verarbeitet. Durch die Nutzung
							dieser Website erklären Sie sich mit der Verarbeitung dieser Informationen und Angaben
							einverstanden und erklären, dass alle von Ihnen gemachten Angaben wahrheitsgemäß und
							korrekt sind.
						</p>
					</div>
					<div className="tarms_item">
						<h5 className="tarms_heading5">4. NUTZUNG DER WEBSITE</h5>
						<p className="text">
					...
					<div className="tarms_item">
						...
						<p className="text">
							...
							Angebots und kein Verkaufsangebot dar. Kein Vertrag in Bezug auf die Produkte besteht
							zwischen Ihnen und dem Verkäufer, bis wir Ihre Bestellung angenommen haben (unabhängig
							davon, ob der Gesamtbetrag der Bestellung von Ihrem Konto abgebucht wurde oder nicht).
							Wenn Ihre Bestellung nicht angenommen wird, der Betrag aber bereits von Ihrem Konto
							abgebucht wurde, erhalten Sie eine vollständige Rückerstattung.
						</p>
					</div>
					<div className="tarms_item">
						<h5 className="tarms_heading5">7. WEBSITE-ABONNEMENT</h5>
						<p className="text">
					...
					<div className="tarms_item">
						<h5 className="tarms_heading5">8. PRODUKTVERFÜGBARKEIT</h5>
						<p className="text">
							Alle Produktbestellungen sind von der Verfügbarkeit der Produkte abhängig.
							Dementsprechend behalten wir uns das Recht vor, Ihnen im Falle von Lieferproblemen
							oder wenn die Produkte nicht mehr vorrätig sind, durch vorherige Ankündigung Ersatz
							von gleicher oder höherer Qualität und höherem Wert anzubieten, den Sie dann
							nachbestellen können. Wenn Sie solche Ersatzprodukte nicht bestellen möchten,
							erstatten wir Ihnen die bereits gezahlten Gelder zurück.
						</p>
					</div>
					<div className="tarms_item">
						<h5 className="tarms_heading5">9. ABLEHNUNG VON BESTELLUNGEN</h5>
						<p className="text">
							Wir behalten uns das Recht vor, jederzeit Produkte von der Website zu entfernen
							und/oder Inhalte oder Informationen, die auf der Website erscheinen, zu ersetzen oder
							zu ändern. Obwohl wir alle Anstrengungen unternehmen werden, um auf eingereichte
							Bestellungen zu reagieren, kann es außergewöhnliche Umstände geben, die es
							erforderlich machen, dass wir die Bearbeitung oder Annahme einer Bestellung nach ihrem
							Eingang und nachdem wir Ihnen eine Auftragsbestätigung geschickt haben, ablehnen.
							Weder Sie noch Dritte können uns haftbar machen für unsere
						</p>
					</div>
					<div className="tarms_item">
						<h5 className="tarms_heading5">10. LIEFERUNG</h5>
						<p className="text">
							Verzögerungen können durch die kundenspezifische Anpassung von Produkten,
							unvorhergesehene Umstände oder den Lieferbereich entstehen. <br />
							<br />
							Was die digitalen Geschenkkarten betrifft, so werden Ihnen diese an dem von Ihnen bei
							der Bestellung angegebenen Datum zugestellt. <br />
							<br />
							Wenn wir das Lieferdatum aus irgendeinem Grund nicht einhalten können, werden wir Sie
							benachrichtigen und Ihnen entweder die Fortsetzung des Kaufs mit einem neuen
							Lieferdatum oder die Stornierung Ihrer Bestellung mit vollständiger Rückerstattung der
							gezahlten Beträge vorschlagen. Sie sollten bedenken, dass samstags und sonntags keine
							Hauszustellung erfolgt, außer im Falle einer digitalen Geschenkkarte, die an dem von
							Ihnen festgelegten Datum zugestellt wird. <br />
							<br /> Im Sinne dieser Allgemeinen Geschäftsbedingungen gilt die "Lieferung" als
							ausgeführt bzw. die Bestellung als "geliefert", wenn Sie oder ein von Ihnen benannter
							Dritter die Produkte in den materiellen Besitz der Produkte gelangt, was mit der
							Unterzeichnung der Empfangsbestätigung der Bestellung an der vereinbarten
							Lieferadresse geschieht.
						</p>
					</div>
					<div className="tarms_item">
						<h5 className="tarms_heading5">11. UNFÄHIGKEIT ZU LIEFERN</h5>
						<p className="text">
							Wenn wir nicht liefern können, werden wir uns bemühen, einen sicheren, geschützten Ort
							zu finden, an dem wir Ihr Paket abgeben können. Wenn wir keinen sicheren, geschützten
							Ort finden, werden Ihre Produkte an unser Depot zurückgeschickt. Wir werden Sie
							schriftlich darüber informieren, wo Sie Ihr Paket finden können und welche Optionen
							für eine neue Lieferung zur Verfügung stehen. Wenn Sie zum vereinbarten Zeitpunkt
							nicht am Lieferort anwesend sein werden, sollten Sie sich mit uns in Verbindung
							setzen, um einen neuen, für beide Seiten günstigen Liefertermin zu vereinbaren. Wenn
							Ihre Bestellung ohne unser Verschulden nicht innerhalb von 30 Tagen nach Verfügbarkeit
							Ihrer Bestellung am Lieferort geliefert wird, werden wir davon ausgehen, dass Sie
							beabsichtigen, den Vertrag zu stornieren, und sie wird als solche betrachtet. Nach
							Beendigung des Vertrags erstatten wir den für die Produkte gezahlten Preis
							einschließlich der Lieferkosten (mit Ausnahme etwaiger zusätzlicher Kosten im
							Zusammenhang mit der gewählten Liefermethode mit Ausnahme der günstigsten angebotenen
							Standardlieferung) so schnell wie möglich vollständig zurück, was in jedem Fall
							spätestens 14 Tage nach dem Datum, an dem wir den Vertrag als beendet betrachten, der
							Fall sein wird.
							<br />
							<br />
							Diese Klausel gilt nicht für die digitale Geschenkkarte, deren Lieferung durch die
							Bestimmungen der Nutzungsbedingungen der Geschenkkarte und Klausel 9 oben geregelt
							ist.
						</p>
					</div>
					<div className="tarms_item">
						<h5 className="tarms_heading5">12. RISIKO UND TITEL</h5>
						<p className="text">
							Sie tragen alle Risiken im Zusammenhang mit den Produkten ab dem Zeitpunkt der
							Lieferung. Das Eigentum an den Produkten geht erst dann auf Sie über, wenn wir die
							vollständige Zahlung der für das Produkt geschuldeten Gelder einschließlich der
							Lieferkosten erhalten haben, d.h. ab dem Lieferdatum (wie in Klausel 9 angegeben),
							wenn die Produkte bezahlt wurden, oder am Zahlungstag, wenn dies nach der Lieferung
							erfolgt.
						</p>
					</div>
					<div className="tarms_item">
						...
						<p className="text">
							...
							<br />
							Die auf unserer Website genannten Preise enthalten die Mehrwertsteuer; die
							Lieferkosten sind jedoch nicht inbegriffen und werden gemäß den Bestimmungen unseres
							Lieferpreisleitfadens zu dem fälligen Gesamtbetrag hinzugerechnet. <br />
							<br />
							Die Preise können sich jederzeit ändern, aber Änderungen wirken sich nicht auf die
							Bestellungen aus, für die wir bereits eine Versandbestätigung versandt haben,
							vorbehaltlich der oben genannten Bestimmungen. <br />
							<br />
							Nachdem Sie alle Artikel, die Sie kaufen möchten, ausgewählt haben, werden sie in
							Ihren Warenkorb gelegt. Der nächste Schritt umfasst die Bearbeitung Ihrer Bestellung
							und die Durchführung der Zahlung. Zu diesem Zweck müssen Sie den verschiedenen
					...
					<div className="tarms_item">
						...
						<p className="text">
							...
							Kunden auf den Kanarischen Inseln, in Ceuta und Melilla. In diesem Zusammenhang und in
							Übereinstimmung mit Titel V Kapitel I der Richtlinie 2006/112/EG vom 28. November 2006
							über das gemeinsame Mehrwertsteuersystem gilt als Ort der Lieferung der Ort innerhalb
							des Mitgliedstaates an der Adresse, an die die Gegenstände geliefert werden sollen,
							und die anwendbare Mehrwertsteuer entspricht dem geltenden Satz des Mitgliedstaates,
							in dem die Gegenstände gemäß den Bestellungen geliefert werden sollen. Gemäß den in
							den einzelnen Ländern geltenden Regeln und Vorschriften kann die in Artikel 194 der
							Richtlinie 2006/112/EG festgelegte Regel auf in bestimmten Mitgliedstaaten der
							Europäischen Union gelieferte Waren anwendbar sein, wenn der Kunde ein
							Steuerpflichtiger für Mehrwertsteuerzwecke ist oder sein sollte. Wenn dies der Fall
							ist, stellen wir keine Mehrwertsteuer in Rechnung, vorbehaltlich der Bestätigung des
							Empfängers der Lieferung, dass die Mehrwertsteuer auf die gelieferten Artikel vom
							Kunden gemäß dem in oben genanntem Artikel 194 genannten Verfahren bezahlt wird. In
							Bezug auf Bestellungen, die auf den Kanarischen Inseln, in Ceuta und Melilla geliefert
							werden sollen, sind solche Bestellungen gemäß Artikel 146 der oben genannten
							Richtlinie von der Mehrwertsteuer befreit und unterliegen den Steuern und Zöllen gemäß
							den geltenden Vorschriften und Bestimmungen.
						</p>
					</div>
					<div className="tarms_item">
						...
						<p className="text">
							...
							Kosten zurücksenden. Die Produkte müssen innerhalb von 14 Tagen nach Ausübung des
							Widerrufsrechts durch den Kunden physisch an United Nutrition UÖ zurückgegeben werden.
							Nach diesen 14 Tagen ist der Verkauf endgültig. Die Produkte müssen in ihrer
							Originalverpackung mit den Original-Etiketten zurückgeschickt werden, nagelneu, ohne
							sie benutzt oder gewaschen zu haben. Wenn diese Bedingungen nicht erfüllt werden,
							verlieren Sie Ihr Recht auf Rückkehr. Die Rücksendung des/der Produkte(s) liegt in der
							Verantwortung des Kunden und erfolgt auf sein eigenes Risiko.
						</p>
					</div>
					<div className="tarms_item">
					...
					<div className="tarms_item">
						<h5 className="tarms_heading5">17.3 ALLGEMEINE BESTIMMUNGEN</h5>
						<p className="text">
							Sie haben nicht das Recht, den Vertrag zu kündigen, wenn einer der folgenden Artikel
							geliefert wurde: <br />
							<br />
							1. Personalisierte Artikel; <br />
							<br />
							2. Elektronische Diesntleistungen <br />
							<br />
							3. Waren, die Sie nach der Lieferung entsiegelt haben und die aus Gründen der Hygiene
							oder Gesundheitssicherheit nicht zurückgegeben werden können. <br />
							<br />
							Ihr Widerrufsrecht erstreckt sich nur auf Artikel, die im gleichen Zustand
							zurückgegeben werden, in dem Sie sie erhalten haben. Es wird keine Rückerstattung
							gewährt, wenn der Artikel (i) nach dem Öffnen benutzt wurde, (ii) sich nicht im
							...
							<br />
							Nach Prüfung des zurückgesandten Artikels informieren wir Sie darüber, ob Sie Anspruch
							auf eine Rückerstattung der gezahlten Beträge haben oder nicht. Die Versandkosten
							...
							verantwortlich, wie oben angegeben. Bitte denken Sie in diesem Fall daran, zusammen
							mit den zurückgesandten Waren einen Ausdruck des der Versandbestätigung beigefügten
							E-Tickets vorzulegen.
						</p>
					</div>
					<div className="tarms_item">
						...
						<p className="text">
							...
							oder umtauschen, was in jedem Fall innerhalb von 14 Tagen ab dem Datum unserer
							E-Mail-Bestätigung, dass Sie Anspruch auf einen Ersatz oder eine Rückerstattung für
							den fraglichen Artikel haben, erfolgen sollte. <br />
							<br />
							Wenn der Mangel oder Schaden nachgewiesen wird, wird der Preis der betreffenden
							Artikel, einschließlich der Lieferkosten und der Kosten für die Rücksendung der
					...
					<div className="tarms_item">
						...
						<p className="text">
							...
							streng auf den Kaufpreis des betreffenden Produkts beschränkt. <br />
							<br />
							Ungeachtet des Vorstehenden kann nichts in diesen Allgemeinen Geschäftsbedingungen
							unsere Haftung ausschließen oder einschränken: <br />
							<br />
							...
							Betriebsverluste; <br />
							<br />
							Verlust von Gewinnen oder Verträgen; <br />
							<br />
							...
							stillschweigende Garantie zur Verfügung gestellt, es sei denn, dies wird gesetzlich
							garantiert. In diesem Zusammenhang werden wir, wenn Sie als Kunde einen Vertrag
							abschließen, die Produkte gemäß den vertraglichen Bestimmungen liefern und haften
							Ihnen gegenüber im Falle einer zum Zeitpunkt der Lieferung festgestellten
							Vertragswidrigkeit. Produkte werden als konform mit den vertraglichen Bestimmungen
							betrachtet, wenn die folgenden Bedingungen erfüllt sind: (1) sie mit der von uns
							gelieferten Beschreibung übereinstimmen und die auf der Website angegebenen Merkmale
							aufweisen; (2) sie für die Zwecke geeignet sind, für die Produkte ihres Typs im
					...
					<div className="tarms_item">
						...
						<p className="text">
							...
							Pferde, Würmer, Logikbomben oder andere Arten von Software oder Material einführen,
							die bösartig oder technologisch schädlich sind. Sie dürfen nicht versuchen, sich
							...
							andere Website, auf die Sie möglicherweise weitergeleitet werden, beeinträchtigen
							könnten.
						</p>
					</div>
					<div className="tarms_item">
						...
						<p className="text">
							...
							Materialien bleibt außerhalb unserer Kontrolle. Wir können daher nicht für Verluste
							oder Schäden haftbar gemacht werden, die sich aus ihrer Verwendung ergeben.
						</p>
					</div>
					<div className="tarms_item">
						...
						<p className="text">
							...
							anderen Mitteilungen, die wir Ihnen auf elektronischem Wege zukommen lassen, den
							gesetzlichen Anforderungen an die Schriftform dieser Mitteilungen entsprechen. Diese
							Klausel hat keinen Einfluss auf Ihre gesetzlichen Rechte. Wir können daher nicht für
							Verluste oder Schäden haftbar gemacht werden, die sich aus ihrer Verwendung ergeben.
						</p>
					</div>
					<div className="tarms_item">
						...
						<p className="text">
							...
							zugestellt, sobald sie auf unserer Website veröffentlicht wurden, 24 Stunden nach dem
							Versand von <br />
							<br />
							eine E-Mail oder drei Tage nach dem Datum der Aufgabe eines Briefes. Als Nachweis für
							die Zustellung einer Mitteilung reicht es aus, im Falle eines Briefes nachzuweisen,
							dass dieser ordnungsgemäß adressiert, abgestempelt und zur Post gebracht wurde; und im
							Falle einer E-Mail, dass sie an die vom Empfänger angegebene E-Mail-Adresse geschickt
							wurde.
						</p>
					</div>
					<div className="tarms_item">
						...
						<p className="text">
							...
							Zustimmung dürfen Sie einen Vertrag oder eines Ihrer Rechte oder Verpflichtungen, die
							sich aus diesem Vertrag ergeben, in keiner Weise übertragen, abtreten, belasten oder
							veräußern. Um Zweifel auszuschließen, wird keine Übertragung, Abtretung, Belastung
							oder Veräußerung wie oben erwähnt Ihre gesetzlichen Rechte als Kunde beeinträchtigen,
							noch wird dadurch eine implizite oder ausdrückliche Garantie, die wir Ihnen gegenüber
							abgegeben haben, in irgendeiner Weise widerrufen, reduziert oder eingeschränkt. Wir
							sind berechtigt, einen Vertrag oder eines unserer Rechte und Pflichten, die sich aus
							diesem Vertrag ergeben, jederzeit während der Vertragserfüllung zu übertragen,
							abzutreten, in Rechnung zu stellen, unterzuvergeben oder anderweitig darüber zu
							verfügen.
						</p>
					</div>
					<div className="tarms_item">
						...
						<p className="text">
							...
							Kontrolle ("Höhere Gewalt") verursacht werden. Ein Fall von Höherer Gewalt umfasst
							jede Handlung, jedes Ereignis, jede Nichterfüllung, jede Unterlassung oder jeden
							...
							unsere Leistungsfristen werden entsprechend verlängert. Wir werden uns im Rahmen des
							Möglichen bemühen, die Höhere Gewalt zu beenden oder eine Lösung zu finden, die es uns
							ermöglicht, unsere vertraglichen Verpflichtungen trotz der Höheren Gewalt zu erfüllen.
						</p>
					</div>
					<div className="tarms_item">
						...
						<p className="text">
							...
							diesen Geschäftsbedingungen bestehen oder eines unserer Rechte oder Rechtsmittel, die
							uns aufgrund des Vertrags oder dieser Geschäftsbedingungen zur Verfügung stehen, nicht
							ausüben, stellt dies weder einen Verzicht auf die entsprechenden Rechte oder
							Rechtsmittel dar, noch entbindet es Sie von der Einhaltung dieser Verpflichtungen.
							Unser Verzicht in Bezug auf einen Verstoß stellt keinen Verzicht für einen späteren
							Verstoß dar.
						</p>
					</div>
					<div className="tarms_item">
						...
						<p className="text">
							...
							befunden werden, so wird diese Bestimmung von den übrigen Bestimmungen getrennt, die
							im größtmöglichen gesetzlich zulässigen Umfang gültig bleiben.
						</p>
					</div>
					<div className="tarms_item">
						...
						<p className="text">
							...
							geschlossen wurde, und sie haben Vorrang vor allen vorherigen Vereinbarungen,
							Absprachen oder Absprachen, ob schriftlich oder mündlich, zwischen Ihnen und uns.
							Jeder von uns erkennt an, dass sich durch den Abschluss des Vertrages keine Partei auf
							eine Erklärung, Zusage oder ein Versprechen der anderen Partei beruft oder sich
							implizit auf eine mündliche oder schriftliche Erklärung bezieht, die während früherer
							Verhandlungen zu diesem Vertrag abgegeben wurde, an denen wir zuvor teilgenommen
							hatten, es sei denn, dies ist ausdrücklich in diesen Geschäftsbedingungen angegeben.
							Jede Partei verzichtet auf jedes Rechtsmittel gegen falsche mündliche oder
							schriftliche Aussagen, die von der anderen Partei vor dem Datum des Vertrags gemacht
							wurden (es sei denn, solche falschen Aussagen wurden in betrügerischer Absicht
							gemacht); das einzige verfügbare Rechtsmittel sollte die Kündigung des Vertrags gemäß
							diesen Geschäftsbedingungen sein.
						</p>
					</div>
					<div className="tarms_item">
						<h5 className="tarms_heading5">
							27. UNSER RECHT, DIESE BEDINGUNGEN UND KONDITIONEN ZU ÄNDERN
						</h5>
						<p className="text">
							Wir sind berechtigt, diese Allgemeinen Geschäftsbedingungen von Zeit zu Zeit zu
							überarbeiten und zu ändern. Sie unterliegen den Richtlinien und Geschäftsbedingungen,
							die zu dem Zeitpunkt in Kraft sind, an dem Sie Produkte bei uns bestellen, es sei
							denn, eine Änderung dieser Richtlinien, Geschäftsbedingungen oder der
							Datenschutzerklärung ist gesetzlich oder durch eine Regierungsbehörde erforderlich; in
							diesem Fall gelten mögliche Änderungen auch für Bestellungen, die zuvor von Ihnen
							aufgegeben wurden.
						</p>
					</div>
					<div className="tarms_item">
						<h5 className="tarms_heading5">28. ANWENDBARES RECHT UND GERICHTSBARKEIT</h5>
						<p className="text">
