		...
		<div className="tarms">
			...
			<div className="container">
				<div className="tarms-header">
					...
					<h2 className="tarms_heading2_secondary text-center">Datenschutz</h2>
					{/* <p className="text">
				...
				<div className="tarms_wrapper">
					<div className="tarms_item">
						...
						<p className="text">
							...
							"Verordnung" oder "GDPR"), und im Allgemeinen in Übereinstimmung mit dem in der
							Verordnung selbst vorgesehenen Grundsatz der Transparenz werden die folgenden
							Informationen über die Verarbeitung personenbezogener Daten (d.h. alle Informationen
							über eine bestimmte oder bestimmbare natürliche Person "Interessent“) zur Verfügung
					...
					<div className="tarms_item">
						...
						<p className="text">
							...
							dass die Website bei einem erneuten Besuch besser auf Ihre Bedürfnisse zugeschnitten
