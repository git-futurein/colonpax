...
const PercentageSection = () => {
	return (
		<div className="my-5 main_box" id="ergebnisse">
			...
			<div className="container percent_bg">
				<div className="">
					...
					<p className="percent_p">
						Die Aussagen unserer Kunden sprechen für sich, fast alle Anwender stellen eine
						Verbesserung der Darm - und allgemeinen Gesundheit fest.
					</p>
				</div>
				<div className="row text-center">
					...
					<p className="stand_p">
						*Stand Oktober 2022 / Kundenumfrage aller Colonpax Anwender (Die Zahlen werden monatlich
						ausgewertet und erhalten ein Update)
					</p>
				</div>
			</div>
			<div className="usvg">
