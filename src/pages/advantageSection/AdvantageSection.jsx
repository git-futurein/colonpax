				...
				<div className="col-lg-6 col-md-6">
					<div className="content-box">
						...
						<div>
							...
							<p className="adv_p">
								Der einzigartige Komplex aus essenziellen Nährstoffen fördert die Entgiftung deines
								Körpers, indem es den Darm ganzheitlich reinigt und exogene und endogene Toxine
								absorbiert, die das Darmnervensystem schädigen können.
							</p>
						</div>
					</div>
				</div>
				<div className="col-lg-6 col-md-6">
					<div className="content-box">
						...
						<div>
							...
							<p className="adv_p">
								Colonpax ist ein einzigartiger Ballaststoffkomplex, der die Darmflora und das
								Verdauungssystem verbessert und deinen Stoffwechsel wieder in Schwung bringt.
							</p>
						</div>
					</div>
				</div>
				<div className="col-lg-6 col-md-6">
					<div className="content-box">
						...
						<div>
							...
							<p className="adv_p">
								Colonpax kann deine Energie steigern und bring die Darmfunktion in Schwung. Es löst
								die Verstofung, reduziert den Blähbauch und Blähungen und lindert die Krämpfe.
							</p>
						</div>
					</div>
				</div>
					...
					<div className="content-box">
						...
						<div>
							...
							<p className="adv_p">
								...
								Ballaststoffkomplex, der Darmbeschwerden wie Durchfall und Verstopfung lindert, den
								Blutzuckerspiegel reguliert und das Abnehmen beschleunigt
							</p>
						</div>
					</div>
				</div>
