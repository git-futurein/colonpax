		...
		<section id="feature">
			<div className="container">
				<div className="row">
					<div className="col-md-8 m-auto text-center">
						...
						<p className="features_p">
							Keiner spricht gern darüber: Dabei leiden alleine in Deutschland 20 Millionen Menschen
							an wiederkehrenden Darmbeschwerden wie Blähungen und Bauchschmerzen. Mit Colonpax
							konnten wir bereits über tausenden Menschen helfen. Trau dich und entgifte deinen
							Körper, verbessere deine Verdauung und nimm sicher ab .
						</p>
					</div>
				...
				<div className="row">
					...
					<div className="col-lg-2 none"></div>
					<div className="col-lg-4 col-md-6 green_div">
						...
						<hr />
						<p>
							<i className="fa-solid fa-check"></i>regelmässiger Stuhlgang
						</p>
						<hr />
						<p>
							<i className="fa-solid fa-check"></i>regelmässige Vardauung
						</p>
						<hr />
						<p>
