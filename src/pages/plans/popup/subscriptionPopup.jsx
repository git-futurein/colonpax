...
const SubscriptionPopup = () => {
  ...
  const importLead = (e) => {
    ...
    fetch(`https://colonpax.com/api/leads.php/?${formBody}`).then(
      async (response) => {
        ...
        {popupNumber === 1 && (
          <div className={popupNumber === 1 ? "shipping" : "shipping d-none"}>
            <div className="popup-header">
              ...
              <h2 className="heading-2 mt-4 mb-4 text-center">
                Geben Sie Ihre Versanddaten ein
              </h2>
            </div>
            <form className="shipping-form mb-5" onSubmit={importLead}>
              <input
                required
                type="text"
                placeholder="Vorname"
            ...
            <div className="d-flex align-items-center justify-content-center address">
              <p className="text text-center">
                United Nutrition OÜ, Järvevana tee 9, 11314 - Tallin, Harju
                maakond - Estland
              </p>
            </div>
          </div>
        ...
        {popupNumber === 2 && (
          ...
          >
            <div className="popup-header">
              ...
              <h2 className="heading-2 mt-4 mb-4 text-center">
                Gib eine sichere Zahlungsart an
              </h2>
            </div>
              ...
              <div className="payment_item product-list">
                <div className="gift d-flex justify-content-between flex-wrap">
                  ...
                  <div className="amount">
                    €{(58.99 * selectedSubscription.qty).toFixed(2)}
                  </div>
                </div>
                <div className="discount d-flex justify-content-between flex-wrap">
                  ...
                  <div className="amount text-danger">
                    - €
                    {(
                      58.99 * selectedSubscription.qty -
