...
const SubscriptionPopup = () => {
  ...
  useEffect(() => {
    if (window.paypal && popupNumber == 2) {
      window.paypal
        .Buttons({
          style: {
            layout: "vertical",
        ...
        {popupNumber === 1 && (
          <div className={popupNumber === 1 ? "shipping" : "shipping d-none"}>
            ...
            <form className="shipping-form mb-5">
              ...
              <select name="" id="">
                <option value="Austria (FREE shipping)">
              ...
              <div className="d-flex align-items-start gap-2">
                ...
                <label htmlFor="contact-checkbox" className="contact-label">
                  I want to get special deals and discounts from ColonBroom by
                  SMS
                </label>
              </div>
              {showContactConditions && (
                <div className="desc">
                  By checking the box, you agree to receive marketing text
                  messages from ColonBroom at the number provided, including
                  messages sent by autodialer. Consent is not a condition of any
                  purchase. Msg&Data rates may apply. Message frequency varies.
                  Reply HELP for help or STOP to cancel. Check our Privacy
