							...
							<div className="payment_item">
								<div className="gift d-flex justify-content-between flex-wrap">
									...
									<div className="amount">
										...
										{(
											...
											(selectedSubscription.subtotal * selectedSubscription.discount) / 100
										).toFixed(2)}
									</div>
								</div>
								<div className="discount d-flex justify-content-between flex-wrap">
									...
									<div className="amount">
										- €
										{(
											(selectedSubscription.subtotal * selectedSubscription.discount) /
											100
										).toFixed(2)}
									</div>
								</div>
								...
								{showCouponForm && (
									<form className="my-3" onSubmit={handleCoupon}>
										<div className="couponbox d-flex align-items-center justify-content-between gap-4">
											...
											/>
											<button className="btn btn-coupon-apply">apply</button>
