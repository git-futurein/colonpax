	...
	const diesesItemData = [
		{
			...
			title: 'Inulin',
			desc: 'Der in Colonpax verwendet kalorienarme Ballaststoff Inulin ist in Studien bewährt. Inulin reguliert den Energiestoffwechsel, kurbelt die Verdauung an und löst auch Verstopfungen. Es kettet sich an Flüssigkeiten und quillt auf, wodurch der Stuhlgang normalisiert wird und du dich länger satt fühlst (1). Hyperlink to Studies',
		},
		{
			id: 2,
			img: '/images/diese-img-2.png',
			title: 'Flohsamenschalenpullver',
			desc: 'Das in Colonpax verwendete hochkonzentrierten Flohsamenschalenpullver ist ein wahrer Alleskönner: Es reguliert sie Blutdruck, die Blutfette und auch den Blutzuckerspiegel und unterstützt gleichzeitig das Abnehmen. Es fördert eine gesunde Darmflora und hilft bei Darmbeschwerden, stoppt den Durchfall und löst die Verstopfung. (2) Hyperlink to Studies',
		},
		{
			id: 3,
			img: '/images/diese-img-3.png',
			title: 'Guar',
			desc: 'Colonpax enthält konzentriertes Guar. Durch Studien belegt, besitzt es nicht nur eine aufquellende Wirkung und schützt dich somit vor Heisshunger und Essattacken, sondern auch eine bindende Wirkung. So werden Fette im Körper aufgefangen, was wiederum zu einer Reduzierung des Körpergewicht führt. Es unterstützt die Darmfunktion und hilft dabei exogene und endogene Toxine zu absorbieren, die das Darmnervensystem schädigen können. (2) Hyperlink to studies',
		},
		{
			id: 4,
