				...
				<div className="row overflow-hidden">
					<div className="col-md-7 hero_div">
						...
						<p className="common_p">
							...
							Weise lösen, Gewicht reduzieren und auch Blähungen vermindern kannst. Beantworte das
							kostenfreie Quiz und erfahre, wie es dir helfen kann.
						</p>
						...
						<p className="little_p">
							„Seitdem ich Colonpax nehme, ist mein Blähbauch verschwunden und ich habe weniger
							Darmbeschwerden, auch mein ständiger Heisshunger und meine Lust auf Süßes oder
							Fastfood ist einfach weg. Außerdem schmeckt es SO GUT.“
						</p>
