...
const Weight = () => {
  ...
  const { healthCollectData, gender, userCollectData } = useSelector(
    (state) => state.counter
  );
            ...
            <div className="deine__list">
              ...
              <div className="deine__item d-flex align-items-start">
                ...
                <div className="desc">
                  ...
                  <p className="text">
                    Dein Stoffwechsel ist langsamer als er sein sollte Dein
              ...
              <div className="deine__item d-flex align-items-start">
                ...
                <div className="desc">
                  ...
                  <p className="text">
                    Bei dir könnte ein übermäßiges Wachstum des Hefepilzes
